...
const Navbar = () => {
       return (
              <nav class="menu-section bg-white border-gray-200 dark:bg-gray-900">
                     <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                            <span class="self-center text-2xl font-bold whitespace-nowrap dark:text-white">
                                   Todola
                                   <sup>
                                          <span class="bg-blue-100 text-blue-800 text-xs font-medium mr-2 ml-1.5 px-1.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">Beta</span>
                                   </sup>
                            </span>
